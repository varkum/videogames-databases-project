...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference("Score.count") do
      post scores_url, params: { score: { type: @score.type, videogame_id: @score.videogame_id } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { type: @score.type, videogame_id: @score.videogame_id } }
